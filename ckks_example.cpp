...
<< context_server.get_context_data(zc.parms_id())->chain_index() << endl; //2
cout << "    + Modulus chain index for temp(x*y): "
<< context_server.get_context_data(temp.parms_id())->chain_index() << endl;//1
cout << "    + Modulus chain index for wt: "
<< context_server.get_context_data(wt.parms_id())->chain_index() << endl;//2
...
<< context_server.get_context_data(zc.parms_id())->chain_index() << endl;//1
